...
object FPJson extends App {
  ...
  object InstancesTask {
    ...
    implicit val intJsonable: Jsonable[Int] = (value: Int) => Json(value.toString)
...
//    def prettyPrintAfter[A: Jsonable](a: A): Unit = println(Jsonable[A].toJson((a)))
  }
